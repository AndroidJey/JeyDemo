...
public class CalendarAdapter extends BaseAdapter {
	...
	public CalendarAdapter(Context activity, List<DateInfo> list) {
...
//			convertView.setBackgroundResource(R.drawable.item_bkg);
		...
		convertView.setLayoutParams(new GridView.LayoutParams(LayoutParams.WRAP_CONTENT, DateUtils.getScreenWidth((Activity) context) / 7));
		return convertView;
	}
