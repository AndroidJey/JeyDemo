package com.jey.jlibs.view.StickyVIew;
...
import com.jey.jlibs.view.StickyVIew.caching.HeaderProvider;
import com.jey.jlibs.view.StickyVIew.caching.HeaderViewCache;
import com.jey.jlibs.view.StickyVIew.calculation.DimensionCalculator;
import com.jey.jlibs.view.StickyVIew.rendering.HeaderRenderer;
import com.jey.jlibs.view.StickyVIew.util.LinearLayoutOrientationProvider;
import com.jey.jlibs.view.StickyVIew.util.OrientationProvider;
...
//        if (mAdapter.getHeaderViewSet() != null) {
//            List<View> headerViewList = mAdapter.getHeaderViewSet();
//            for (int k = 0; k < headerViewList.size(); k++) {
//                View headerItemView = headerViewList.get(k);
//                if (headerItemView == view) {
//                    Log.i("msgg", "getItemOffsets true");
//                    return;
//                } else {
//                    Log.i("msgg", "getItemOffsets false");
//                }
//            }
//        }
...
//        setItemOffsetsForHeader(outRect, header, mOrientationProvider.getOrientation(parent));
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        if (childCount <= 0 || mAdapter.getHeaderItemCount() <= 0) {
            return;
        }
