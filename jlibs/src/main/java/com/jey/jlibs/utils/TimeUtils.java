...
import com.jey.jlibs.calender.DateUtils;
import com.jey.jlibs.calender.DateInfo;
import com.jey.jlibs.calender.Lunar;
...
public class TimeUtils {
	...
	public static List<DateInfo> initCalendar(String formatDate, int month) throws Exception {
    	...
    	int front = DateUtils.getFirstIndexOf(list);
    	int back = DateUtils.getLastIndexOf(list);
