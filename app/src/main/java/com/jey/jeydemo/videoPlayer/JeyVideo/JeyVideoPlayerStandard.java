 ...
 * On 2017/05/02 00:01
 */
public class JeyVideoPlayerStandard extends JeyVideoPlayer {
    ...
    public JeyVideoPlayerStandard(Context context) {
        super(context);
    }

    public JeyVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(JeyUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void startVideo() {
        prepareMediaPlayer();
        onEvent(JeyUserActionStandard.ON_CLICK_START_THUMB);
    }
