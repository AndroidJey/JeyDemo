 ...
 * On 2017/05/02 00:01
 */
public class JeyVideoPlayerSimple extends JeyVideoPlayer {

    public JeyVideoPlayerSimple(Context context) {
        super(context);
    }

    public JeyVideoPlayerSimple(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
