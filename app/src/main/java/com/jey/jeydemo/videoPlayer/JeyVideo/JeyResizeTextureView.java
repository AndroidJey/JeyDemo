 ...
 * On 2017/05/02 00:01
 */
public class JeyResizeTextureView extends TextureView {
    protected static final String TAG = "JCResizeTextureView";

    // x as width, y as height
    protected Point mVideoSize;

    public JeyResizeTextureView(Context context) {
        super(context);
        init();
    }

    public JeyResizeTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
