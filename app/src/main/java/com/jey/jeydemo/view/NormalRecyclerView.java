...
import com.jey.jeydemo.utils.JCache;
import com.jey.jeydemo.utils.OnLoadTopDataListener;
...
//        }
    ...
    public Adapter<BaseViewHolder> getAdapter() {
        return adapter;
    }
        ...
        try {
            if (json.has(LIST)) {
                ...
                if (list.length() > 0) {
                    ...
                    if (page == 1) {
                        if (emptyView == null) {
                            View view = LayoutInflater.from(getContext()).inflate(com.example.jlibs.R.layout.emty_list_view, null);
...
//        }
    ...
    public class BaseRecyclerAdapter extends Adapter<BaseViewHolder> {
